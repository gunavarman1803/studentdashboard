...
var CMultiSelectNativeSelect = React.forwardRef(function (_a, ref) {
    var id = _a.id, options = _a.options, rest = tslib_es6.__rest(_a, ["id", "options"]);
    return (React.createElement("select", tslib_es6.__assign({ className: "multi-select-new" }, (id && { id: "".concat(id, "-multi-select") }), (id && { name: "".concat(id, "-multi-select") }), { tabIndex: -1, style: { display: 'none' } }, rest, { ref: ref }), options && createNativeOptions(options)));
});
