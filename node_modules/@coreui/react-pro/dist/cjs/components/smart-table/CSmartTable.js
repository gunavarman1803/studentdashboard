...
var index_es = require('../../node_modules/@coreui/icons-react/dist/index.es.js');
...
var CSmartTable = React.forwardRef(function (_a, ref) {
    ...
    columns = _a.columns, columnSorter = _a.columnSorter, elementCover = _a.elementCover, footer = _a.footer, _c = _a.header, header = _c === void 0 ? true : _c, items = _a.items, itemsNumber = _a.itemsNumber, _d = _a.itemsPerPage, itemsPerPage = _d === void 0 ? 10 : _d, _e = _a.itemsPerPageLabel, itemsPerPageLabel = _e === void 0 ? 'Items per page:' : _e, _f = _a.itemsPerPageOptions, itemsPerPageOptions = _f === void 0 ? [5, 10, 20, 50] : _f, itemsPerPageSelect = _a.itemsPerPageSelect, loading = _a.loading, _g = _a.noItemsLabel, noItemsLabel = _g === void 0 ? 'No items found' : _g, onActivePageChange = _a.onActivePageChange, onColumnFilterChange = _a.onColumnFilterChange, onFilteredItemsChange = _a.onFilteredItemsChange, onItemsPerPageChange = _a.onItemsPerPageChange, onRowClick = _a.onRowClick, onSelectAll = _a.onSelectAll, onSelectedItemsChange = _a.onSelectedItemsChange, onSorterChange = _a.onSorterChange, onTableFilterChange = _a.onTableFilterChange, pagination = _a.pagination, paginationProps = _a.paginationProps, scopedColumns = _a.scopedColumns, selected = _a.selected, selectable = _a.selectable, _h = _a.selectAll, selectAll = _h === void 0 ? true : _h, sorterValue = _a.sorterValue, _j = _a.sortingIcon, sortingIcon = _j === void 0 ? React.createElement(index_es.default, { width: 18, icon: cilSwapVertical.cilSwapVertical, key: "csv" }) : _j, _k = _a.sortingIconAscending, sortingIconAscending = _k === void 0 ? React.createElement(index_es.default, { width: 18, icon: cilArrowTop.cilArrowTop, key: "cat" }) : _k, _l = _a.sortingIconDescending, sortingIconDescending = _l === void 0 ? React.createElement(index_es.default, { width: 18, icon: cilArrowBottom.cilArrowBottom, key: "cab" }) : _l, tableBodyProps = _a.tableBodyProps, tableFootProps = _a.tableFootProps, tableFilter = _a.tableFilter, _m = _a.tableFilterLabel, tableFilterLabel = _m === void 0 ? 'Filter:' : _m, _o = _a.tableFilterPlaceholder, tableFilterPlaceholder = _o === void 0 ? 'type string...' : _o, tableFilterValue = _a.tableFilterValue, // TODO: consider to use only tableFilter prop
    tableHeadProps = _a.tableHeadProps, tableProps = _a.tableProps, rest = tslib_es6.__rest(_a, ["activePage", "cleaner", "clickableRows", "columnFilter", "columnFilterValue", "columns", "columnSorter", "elementCover", "footer", "header", "items", "itemsNumber", "itemsPerPage", "itemsPerPageLabel", "itemsPerPageOptions", "itemsPerPageSelect", "loading", "noItemsLabel", "onActivePageChange", "onColumnFilterChange", "onFilteredItemsChange", "onItemsPerPageChange", "onRowClick", "onSelectAll", "onSelectedItemsChange", "onSorterChange", "onTableFilterChange", "pagination", "paginationProps", "scopedColumns", "selected", "selectable", "selectAll", "sorterValue", "sortingIcon", "sortingIconAscending", "sortingIconDescending", "tableBodyProps", "tableFootProps", "tableFilter", "tableFilterLabel", "tableFilterPlaceholder", "tableFilterValue", "tableHeadProps", "tableProps"]);
    var mountedRef = React.useRef(false);
    var _p = React.useState(activePage), _activePage = _p[0], setActivePage = _p[1];
    var _q = React.useState([]), _items = _q[0], setItems = _q[1];
    var _r = React.useState(itemsNumber), _itemsNumber = _r[0], setItemsNumber = _r[1];
    ...
    React.useEffect(function () {
        setSorterState(tslib_es6.__assign({}, sorterValue));
    ...
    var filteredColumns = React.useMemo(function () { return utils.filterColumns(_items, columnFilter, columnFilterState, itemsDataColumns); }, [columnFilterState, JSON.stringify(_items)]);
    var filteredTable = React.useMemo(function () { return utils.filterTable(filteredColumns, tableFilter, tableFilterState, itemsDataColumns); }, [tableFilterState, JSON.stringify(tableFilterValue), JSON.stringify(filteredColumns)]);
    var sortedItems = React.useMemo(function () { return utils.sortItems(columnSorter, filteredTable, itemsDataColumns, sorterState); }, [
    ...
    var handleColumnFilterChange = function (colName, value, type) {
        ...
        var newState = tslib_es6.__assign(tslib_es6.__assign({}, columnFilterState), (_a = {}, _a["".concat(colName)] = value, _a));
        setActivePage(1);
    ...
    var handleRowChecked = function (item, value) {
        if (value &&
            !isObjectInArray.default(_selected, item, consts.ITEM_INTERNAL_KEYS)) {
            setSelected(tslib_es6.__spreadArray(tslib_es6.__spreadArray([], _selected, true), [item], false));
            return;
        }
        setSelected(_selected.filter(function (_item) {
            return !isObjectInArray.default([_item], item, consts.ITEM_INTERNAL_KEYS);
        }));
    };
    ...
    var handleSorterChange = function (column, index, order) {
        ...
        setSorterState(tslib_es6.__assign({}, state));
    };
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", tslib_es6.__assign({}, rest, { ref: ref }), (itemsPerPageSelect || tableFilter || cleaner) && (React.createElement("div", { className: "row my-2 mx-0" }, (tableFilter || cleaner) && (React.createElement(React.Fragment, null,
            ...
            React.createElement("div", { className: "col-auto p-0" }, cleaner && (React.createElement("button", tslib_es6.__assign({ type: "button", className: "btn btn-transparent" }, (!(tableFilterState ||
                ...
                React.createElement(index_es.default, { width: 18, icon: cilFilterX.cilFilterX }))))))))),
        ...
        (pagination || itemsPerPageSelect) && (React.createElement("div", { className: "row" },
            React.createElement("div", { className: "col" }, ((pagination && numberOfPages > 1) || (paginationProps && paginationProps.pages > 1)) && (React.createElement(CSmartPagination.CSmartPagination, tslib_es6.__assign({ activePage: _activePage, onActivePageChange: function (page) {
