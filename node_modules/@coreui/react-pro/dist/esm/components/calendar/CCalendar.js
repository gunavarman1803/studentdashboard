...
import { convertToDateObject, isSameDateAs, getDateBySelectionType, getCalendarDate, createGroupsInArray, getMonthsNames, getMonthDetails, getYears, isDateDisabled, isDateInRange, isDateSelected, isToday, isDisableDateInRange } from './utils.js';
        ...
        view === 'days' && (React.createElement("thead", null,
            React.createElement("tr", null,
                ...
                weekDays.map(function (_a, idx) {
                    var date = _a.date;
                    return (React.createElement("th", { key: idx, className: "calendar-cell" },
            ...
            view === 'days' &&
                monthDetails.map(function (week, index) {
                    ...
                    return (React.createElement("tr", __assign({ className: classNames('calendar-row', {
                        ...
                        }), key: index, tabIndex: selectionType === 'week' && current && !isDisabled ? 0 : -1 }, (selectionType === 'week' &&
                        !isDisabled && {
                ...
                listOfMonths.map(function (row, index) {
                    return (React.createElement("tr", { key: index }, row.map(function (month, idx) {
                        ...
                        return (React.createElement("td", __assign({ className: classNames('calendar-cell', {
                            ...
                            }), key: idx, tabIndex: isDisabled ? -1 : 0 }, (!isDisabled && {
                            onBlur: function () { return onCalendarMouseLeave(); },
                            onClick: function () { return onCalendarClick(date); },
                            onFocus: function () { return onCalendarMouseEnter(date); },
                            onKeyDown: function (event) { return onCalendarKeyDown(event, date); },
...
var Navigation = function (props) {
    ...
    return (React.createElement("div", { className: "calendar-nav" },
        navigation && (React.createElement("div", { className: "calendar-nav-prev" },
            React.createElement(CButton, { color: "transparent", size: "sm", onClick: function () { return onNavigationClick('prev', true); } }, navPrevDoubleIcon !== null && navPrevDoubleIcon !== void 0 ? navPrevDoubleIcon : (React.createElement("span", { className: "calendar-nav-icon calendar-nav-icon-double-prev" }))),
            view === 'days' && (React.createElement(CButton, { color: "transparent", size: "sm", onClick: function () { return onNavigationClick('prev'); } }, navPrevIcon !== null && navPrevIcon !== void 0 ? navPrevIcon : React.createElement("span", { className: "calendar-nav-icon calendar-nav-icon-prev" }))))),
        React.createElement("div", __assign({ className: "calendar-nav-date" }, (navYearFirst && { style: { display: 'flex', justifyContent: 'center' } })),
        ...
        navigation && (React.createElement("div", { className: "calendar-nav-next" },
            view === 'days' && (React.createElement(CButton, { color: "transparent", size: "sm", onClick: function () { return onNavigationClick('next'); } }, navNextIcon !== null && navNextIcon !== void 0 ? navNextIcon : React.createElement("span", { className: "calendar-nav-icon calendar-nav-icon-next" }))),
            React.createElement(CButton, { color: "transparent", size: "sm", onClick: function () { return onNavigationClick('next', true); } }, navNextDoubleIcon !== null && navNextDoubleIcon !== void 0 ? navNextDoubleIcon : (React.createElement("span", { className: "calendar-nav-icon calendar-nav-icon-double-next" })))))));
};
